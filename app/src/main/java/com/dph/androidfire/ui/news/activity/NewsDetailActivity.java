...
import com.dph.androidfire.ui.news.model.NewsDetailModel;
import com.dph.androidfire.ui.news.presenter.NewsDetailPresenter;
import com.dph.androidfire.widget.URLImageGetter;
...
public class NewsDetailActivity extends BaseActivity<NewsDetailPresenter, NewsDetailModel> implements NewsDetailContract.View {
    ...
    private void setNewsDetailPhotoIv(String newsImgSrc) {
        Glide.with(this).load(newsImgSrc)
                .fitCenter()
    ...
    private void setNewsDetailBodyTv(final NewsDetail newsDetail, final String newsBody) {
        mRxManager.add(rx.Observable.timer(500, TimeUnit.MILLISECONDS)

package com.dph.androidfire.ui.main.activity;
...
import com.dph.androidfire.bean.TabEntity;
import com.dph.androidfire.ui.main.fragment.CareMainFragment;
import com.dph.androidfire.ui.main.fragment.NewsMainFragment;
import com.dph.androidfire.ui.main.fragment.PhotosMainFragment;
import com.dph.androidfire.ui.main.fragment.VideoMainFragment;
import com.dph.common.base.BaseActivity;
import com.dph.common.baseapp.AppConfig;
import com.dph.common.commonutils.LogUtils;
import com.dph.common.daynightmodeutils.ChangeModeController;
...
public class MainActivity extends BaseActivity {
    ...
    public static void actionStart(Activity activity) {
        ...
        activity.overridePendingTransition(R.anim.fade_in,
                com.dph.common.R.anim.fade_out);
    }
    ...
    public void initView() {
        //此处填上在http：//fir.im注册账号后获得的API_TOKEN以及app的应用ID
...
//        UpdateKey.DialogOrNotification=UpdateKey.WITH_DIALOG;
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        //崩溃前保存位置
        LogUtils.logd("onSaveInstanceState进来了1");
        if(tabLayout!=null){

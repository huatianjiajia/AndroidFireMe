...
public class AppConstant {
    ...
    public static final String CHANEL_POSITION="channel_position";
    public static final String CHANEL_MINE="CHANEL_MINE";
    public static final String CHANNEL_MORE="CHANEL_MORE";
    public static final String CHANNEL_SWAP="CHANEL_SWAP";
    public static final String NEWS_CHANEL_CHANGED="NEWS_CHANEL_CHANGED";
